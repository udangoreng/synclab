...
<head>
    ...
    <title>Kelola Laboran | Portal Akademik</title>
...
<body>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="user-info">
                                        ...
                                        <div>
                                            <div class="user-name">{{ $laboran->nama }}</div>
                                        </div>
                                    </div>
                                </td>
                                <td>{{ $laboran->nomor_induk }}</td>
                                <td>
                                    <div class="action-btns">
                                        <button class="edit-btn" onclick="openModal('edit', {{ $laboran->id }}, '{{ $laboran->nama }}', '{{ $laboran->nomor_induk }}')">
                                            <i class="fas fa-edit"></i> Edit
                                        </button>
                                        <button class="delete-btn" onclick="confirmDelete({{ $laboran->id }}, '{{ $laboran->nama }}')">
                            ...
                            <tr>
                                <td colspan="4">
                                    <div class="empty-state">
                                        ...
                                        <p>Belum ada laboran yang terdaftar</p>
                                    </div>
                                </td>
                            </tr>
                            @endforelse
    ...
    <div class="modal-overlay" id="userModal">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title" id="modalTitle">Tambah Laboran</h2>
    ...
    <div class="modal-overlay" id="deleteModal">
        <div class="modal-content">
            ...
            <p style="margin-bottom: 20px; color: #475569;">Apakah Anda yakin ingin menghapus laboran <strong id="deleteUserName"></strong>?</p>
    ...
    <script>
        function openModal(type, id = null, nama = '', nomor_induk = '') {
            ...
            if (type === 'edit') {
                title.textContent = 'Edit Laboran';
                form.action = '/dosen/laboran/' + id;
                ...
                title.textContent = 'Tambah Laboran';
                form.action = '/dosen/laboran';
                form.reset();
