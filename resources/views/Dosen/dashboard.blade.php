...
.reg-status.success { background: #dcfce7; color: #16a34a; }
.reg-status.warning { background: #fef3c7; color: #d97706; }
...
@media (hover: none) and (pointer: coarse) {
    .nav-item, .stat-card, .detail-btn, .filter-btn, 
    .detail-small-btn, .logout-btn, .course-card {
        cursor: pointer;
        -webkit-tap-highlight-color: transparent;
    }
    
    .nav-item:active, .stat-card:active, .detail-btn:active {
        ...
        <div class="praktikum-grid-cards">
            <div class="praktikum-card">
                <div class="card-header-bg" style="background: linear-gradient(135deg, #10b981, #047857);">
                    <i class="fas fa-network-wired"></i><h3>Jaringan Komputer</h3>
                </div>
                <div class="card-stats">
                    <div class="stat-item"><span class="stat-label">Total Mahasiswa</span><span class="stat-value">58</span></div>
                    <div class="stat-item"><span class="stat-label">Hadir Hari Ini</span><span class="stat-value success">52</span></div>
                    <div class="stat-item"><span class="stat-label">Izin</span><span class="stat-value warning">4</span></div>
                    <div class="stat-item"><span class="stat-label">Tanpa Keterangan</span><span class="stat-value danger">2</span></div>
                </div>
            ...
            <div class="praktikum-card">
                <div class="card-header-bg" style="background: linear-gradient(135deg, #f59e0b, #b45309);">
                    <i class="fas fa-code-branch"></i><h3>RPL</h3>
                </div>
                <div class="card-stats">
                    <div class="stat-item"><span class="stat-label">Total Mahasiswa</span><span class="stat-value">54</span></div>
                    <div class="stat-item"><span class="stat-label">Hadir Hari Ini</span><span class="stat-value success">48</span></div>
                    <div class="stat-item"><span class="stat-label">Izin</span><span class="stat-value warning">4</span></div>
                    <div class="stat-item"><span class="stat-label">Tanpa Keterangan</span><span class="stat-value danger">2</span></div>
                </div>
                <button class="detail-btn">Detail <i class="fas fa-arrow-right"></i></button>
        ...
        <div class="two-columns-dosen">
            <div class="left-col-dosen">
                ...
                <div class="glass-card">
                    <div class="card-title-icon"><i class="fas fa-clipboard-list"></i><h3>Status Pendaftaran Praktikum</h3></div>
                    <div class="registration-list">
                        <div class="reg-item">
                            <div class="reg-info"><span class="reg-name">Jaringan Komputer</span><span class="reg-desc">Pendaftar: 58/100</span></div>
                            <div class="progress-bar-container"><div class="progress-bar" style="width: 58%; background: #10b981;"></div></div>
                            <div class="reg-footer"><span class="reg-status success">Aktif</span><button class="detail-small-btn" data-course="Jaringan Komputer">Detail <i class="fas fa-chevron-right"></i></button></div>
                        </div>
                        <div class="reg-item">
                            <div class="reg-info"><span class="reg-name">RPL</span><span class="reg-desc">Pendaftar: 54/100</span></div>
                            <div class="progress-bar-container"><div class="progress-bar" style="width: 54%; background: #f59e0b;"></div></div>
                            <div class="reg-footer"><span class="reg-status warning">Tersedia</span><button class="detail-small-btn" data-course="RPL">Detail <i class="fas fa-chevron-right"></i></button></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="glass-card">
                    <div class="card-title-icon"><i class="fas fa-check-double"></i><h3>Validasi Nilai</h3><span class="badge-pending">27 Pending</span></div>
                    <div class="validation-summary">
                        <div class="validation-course-card">
                            <div class="course-header"><i class="fas fa-network-wired"></i><strong>Jaringan Komputer</strong></div>
                            <div class="validation-stats"><span class="validated">✓ Tervalidasi: 42</span><span class="pending">⏳ Belum: 16</span></div>
                            <button class="detail-small-btn view-course-valid" data-course="Jaringan Komputer">Lihat Detail</button>
                        </div>
                        <div class="validation-course-card">
                            <div class="course-header"><i class="fas fa-code-branch"></i><strong>RPL</strong></div>
                            <div class="validation-stats"><span class="validated">✓ Tervalidasi: 31</span><span class="pending">⏳ Belum: 11</span></div>
                            <button class="detail-small-btn view-course-valid" data-course="RPL">Lihat Detail</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="right-col-dosen">
                <!-- Rekap Presensi -->
                <div class="glass-card">
                    <div class="card-title-icon"><i class="fas fa-calendar-check"></i><h3>Rekap Presensi</h3></div>
                    ...
                    <div class="attendance-stats" id="attendanceStats">
                        <div class="attendance-circle">
                            <svg viewBox="0 0 100 100">
                                ...
                                <circle cx="50" cy="50" r="45" fill="none" stroke="#3b82f6" stroke-width="8" stroke-dasharray="283" stroke-dashoffset="85" stroke-linecap="round" transform="rotate(-90 50 50)"/>
                            </svg>
                            <div class="circle-text"><span class="percent" id="attendancePercent">0%</span><span class="label">Kehadiran</span></div>
                        </div>
                        <div class="attendance-breakdown" id="attendanceBreakdown"></div>
                    </div>
                    <div class="card-footer-btn"><button class="detail-small-btn" id="attendanceDetailBtn">Detail Presensi <i class="fas fa-arrow-right"></i></button></div>
                </div>
                ...
                <div class="glass-card">
                    ...
                    <canvas id="performanceChart" width="400" height="200" style="width:100%; max-height:200px;"></canvas>
                </div>
            </div>
        </div>
    </main>
...
(function() {
    ...
    const presenceData = {
        '2024A': {
            'Jaringan Komputer': { hadir: 19, izin: 2, sakit: 1, alpha: 1, total: 23, percent: 83 },
            'RPL': { hadir: 17, izin: 2, sakit: 1, alpha: 1, total: 21, percent: 81 }
        },
        '2024B': {
            'Jaringan Komputer': { hadir: 18, izin: 1, sakit: 1, alpha: 2, total: 22, percent: 82 },
            'RPL': { hadir: 16, izin: 2, sakit: 1, alpha: 1, total: 20, percent: 80 }
        },
        '2024C': {
            'Jaringan Komputer': { hadir: 15, izin: 3, sakit: 2, alpha: 1, total: 21, percent: 71 },
            'RPL': { hadir: 15, izin: 2, sakit: 1, alpha: 2, total: 20, percent: 75 }
        }
    };
    ...
    function initChart() {
        ...
        const chartBgColor = matkul === 'Jaringan Komputer' ? 'rgba(16, 185, 129, 0.1)' : 'rgba(245, 158, 11, 0.1)';
        ...
        performanceChart = new Chart(ctx, {
            ...
            options: {
                ...
                scales: { 
                    ...
                    x: {
                        title: { display: true, text: 'Pretest ke-', font: { size: 10 } }
                    }
                }
            }
        });
    ...
    document.querySelectorAll('.detail-small-btn').forEach(btn => {
        btn.addEventListener('click', (e) => {
            e.stopPropagation();
            if (btn.getAttribute('data-course')) {
            } else if (btn.id === 'attendanceDetailBtn') {
                const kelas = document.getElementById('presenceClassFilter').value;
                const matkul = document.getElementById('presenceCourseFilter').value;
