    ...
    <aside class="sidebar">
        ...
        <div class="sidebar-nav" id="sidebarNav">
            <ul class="nav-menu">
                ...
                <li class="nav-item active"><i class="fas fa-check-double"></i> Validasi Nilai</li>
...
(function() {
    ...
    let nilaiData = [
        { id: 1, nama: 'Ahmad Fauzi', nim: '22060001', matkul: 'Jaringan Komputer', kelas: '2024A', pretest: 85, laporan: 80, validated: true },
        { id: 2, nama: 'Siti Rahma', nim: '22060002', matkul: 'Jaringan Komputer', kelas: '2024A', pretest: 78, laporan: 82, validated: true },
        { id: 3, nama: 'Budi Wijaya', nim: '22060003', matkul: 'Jaringan Komputer', kelas: '2024A', pretest: 65, laporan: 70, validated: false },
        { id: 4, nama: 'Dewi Sartika', nim: '22060004', matkul: 'Jaringan Komputer', kelas: '2024A', pretest: 92, laporan: 88, validated: true },
        { id: 5, nama: 'Eko Prasetyo', nim: '22060005', matkul: 'Jaringan Komputer', kelas: '2024A', pretest: 88, laporan: 85, validated: true },
        { id: 6, nama: 'Rina Andriani', nim: '22061001', matkul: 'Jaringan Komputer', kelas: '2024B', pretest: 82, laporan: 78, validated: true },
        { id: 7, nama: 'Dian Permata', nim: '22061002', matkul: 'Jaringan Komputer', kelas: '2024B', pretest: 70, laporan: 68, validated: false },
        { id: 8, nama: 'Andi Saputra', nim: '22061003', matkul: 'Jaringan Komputer', kelas: '2024B', pretest: 75, laporan: 80, validated: true },
        { id: 9, nama: 'Nina Amelia', nim: '22062001', matkul: 'Jaringan Komputer', kelas: '2024C', pretest: 70, laporan: 65, validated: false },
        { id: 10, nama: 'Fajar Nugroho', nim: '22063001', matkul: 'RPL', kelas: '2024A', pretest: 88, laporan: 85, validated: true },
        { id: 11, nama: 'Gina Permata', nim: '22063002', matkul: 'RPL', kelas: '2024A', pretest: 82, laporan: 80, validated: true },
        { id: 12, nama: 'Hendra Gunawan', nim: '22063003', matkul: 'RPL', kelas: '2024A', pretest: 70, laporan: 68, validated: false },
        { id: 13, nama: 'Kartika Dewi', nim: '22064001', matkul: 'RPL', kelas: '2024B', pretest: 78, laporan: 75, validated: true },
        { id: 14, nama: 'Lutfi Hakim', nim: '22064002', matkul: 'RPL', kelas: '2024B', pretest: 75, laporan: 70, validated: false },
        { id: 15, nama: 'Putri Amelia', nim: '22065001', matkul: 'RPL', kelas: '2024C', pretest: 72, laporan: 68, validated: false }
    ];
