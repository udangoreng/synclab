    ...
    <aside class="sidebar">
        ...
        <div class="sidebar-nav" id="sidebarNav">
            <ul class="nav-menu">
                ...
                <li class="nav-item active"><i class="fas fa-clipboard-list"></i> Status Pendaftaran</li>
            </ul>
...
(function() {
    ...
    let pendaftaranData = [
        { id: 1, nama: 'Ahmad Fauzi', nim: '22060001', matkul: 'Jaringan Komputer', kelas: '2024A', praktikum: 'Praktikum Jaringan Komputer - Modul 1', tglDaftar: '2026-03-10', status: 'disetujui', keterangan: 'Disetujui oleh dosen' },
        { id: 2, nama: 'Siti Rahma', nim: '22060002', matkul: 'Jaringan Komputer', kelas: '2024A', praktikum: 'Praktikum Jaringan Komputer - Modul 1', tglDaftar: '2026-03-10', status: 'pending', keterangan: 'Menunggu persetujuan' },
        { id: 3, nama: 'Budi Wijaya', nim: '22060003', matkul: 'Jaringan Komputer', kelas: '2024A', praktikum: 'Praktikum Jaringan Komputer - Modul 2', tglDaftar: '2026-03-15', status: 'ditolak', keterangan: 'Melebihi kuota kelas' },
        { id: 4, nama: 'Dewi Sartika', nim: '22060004', matkul: 'Jaringan Komputer', kelas: '2024A', praktikum: 'Praktikum Jaringan Komputer - Modul 2', tglDaftar: '2026-03-15', status: 'disetujui', keterangan: 'Disetujui oleh dosen' },
        { id: 5, nama: 'Eko Prasetyo', nim: '22060005', matkul: 'Jaringan Komputer', kelas: '2024A', praktikum: 'Praktikum Jaringan Komputer - Modul 3', tglDaftar: '2026-03-20', status: 'pending', keterangan: 'Menunggu persetujuan' },
        { id: 6, nama: 'Rina Andriani', nim: '22061001', matkul: 'Jaringan Komputer', kelas: '2024B', praktikum: 'Praktikum Jaringan Komputer - Modul 1', tglDaftar: '2026-03-10', status: 'disetujui', keterangan: 'Disetujui oleh dosen' },
        { id: 7, nama: 'Dian Permata', nim: '22061002', matkul: 'Jaringan Komputer', kelas: '2024B', praktikum: 'Praktikum Jaringan Komputer - Modul 1', tglDaftar: '2026-03-10', status: 'pending', keterangan: 'Menunggu persetujuan' },
        { id: 8, nama: 'Fajar Nugroho', nim: '22063001', matkul: 'RPL', kelas: '2024A', praktikum: 'Praktikum RPL - Modul 1', tglDaftar: '2026-03-11', status: 'disetujui', keterangan: 'Disetujui oleh dosen' },
        { id: 9, nama: 'Gina Permata', nim: '22063002', matkul: 'RPL', kelas: '2024A', praktikum: 'Praktikum RPL - Modul 1', tglDaftar: '2026-03-11', status: 'disetujui', keterangan: 'Disetujui oleh dosen' },
        { id: 10, nama: 'Hendra Gunawan', nim: '22063003', matkul: 'RPL', kelas: '2024A', praktikum: 'Praktikum RPL - Modul 2', tglDaftar: '2026-03-16', status: 'pending', keterangan: 'Menunggu persetujuan' },
        { id: 11, nama: 'Kartika Dewi', nim: '22064001', matkul: 'RPL', kelas: '2024B', praktikum: 'Praktikum RPL - Modul 1', tglDaftar: '2026-03-11', status: 'disetujui', keterangan: 'Disetujui oleh dosen' },
        { id: 12, nama: 'Lutfi Hakim', nim: '22064002', matkul: 'RPL', kelas: '2024B', praktikum: 'Praktikum RPL - Modul 2', tglDaftar: '2026-03-16', status: 'ditolak', keterangan: 'Tidak memenuhi syarat' },
        { id: 13, nama: 'Putri Amelia', nim: '22065001', matkul: 'RPL', kelas: '2024C', praktikum: 'Praktikum RPL - Modul 1', tglDaftar: '2026-03-11', status: 'pending', keterangan: 'Menunggu persetujuan' }
    ];
    ...
    function updateStatus(id, newStatus) {
        ...
        if (index !== -1) {
            ...
            pendaftaranData[index].keterangan = newStatus === 'disetujui' ? 'Disetujui oleh dosen' : 'Ditolak oleh dosen';
            filterData();
        }
    }
    ...
    function exportData() {
        ...
        filteredData.forEach(item => {
            ...
            csvContent += `${item.nama},${item.nim},${item.matkul},${item.kelas},${item.praktikum},${formatTanggal(item.tglDaftar)},${statusText},${item.keterangan}\n`;
        });
